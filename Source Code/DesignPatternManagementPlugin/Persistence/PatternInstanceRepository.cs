...
{
    /// <summary>
    /// A repository for PatternInstance entities.
    /// </summary>
    public class PatternInstanceRepository : RepositoryBase<PatternInstance>
    {
        #region Fields
        ...
        /// </remarks>
        public PatternInstanceRepository(string filePath)
